...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { activated: @manager.activated, deactivated: @manager.deactivated, department: @manager.department, name: @manager.name } }, as: :json
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { activated: @manager.activated, deactivated: @manager.deactivated, department: @manager.department, name: @manager.name } }, as: :json
    assert_response 200
  end
